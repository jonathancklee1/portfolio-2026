...
function ExperienceDetails({
    ...
    return (
        <div
            className={`${selectedExperience?.company === "Stockland" ? "to-stockland/50" : "to-unsw/80"} text-text from-card hidden h-fit w-full flex-col gap-6 rounded-2xl bg-linear-to-b to-75% p-10 py-16 ring-1 ring-white lg:flex lg:py-12 ${cardClasses} `}
        >
